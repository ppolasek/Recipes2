...
part '../category/category_model.dart';
part '../cookbook/cookbook_model.dart';
part '../history/history_model.dart';
part '../logger/logger_model.dart';
part '../recipe/recipe_model.dart';

class Recipes2AppConfig {
  String serverUrl;
  String contextPath;
  String servletPath;

  Recipes2AppConfig(this.serverUrl, this.contextPath, this.servletPath);
}
...
//  static Recipes2Logger _log = new Recipes2Logger('RecipeConfiguration');
