...
class CookbookService extends WebService {
  ...
  CookbookService(Recipes2Logger logger, BrowserClient http, Recipes2AppConfig config) : super(logger, http, config) {}
...
class WebCookbookService extends WebService implements CookbookService {
  ...
  WebCookbookService(this._log, BrowserClient http, Recipes2AppConfig config) : super(_log, http, config) {
