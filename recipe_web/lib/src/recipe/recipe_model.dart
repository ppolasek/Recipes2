...
class Recipe extends DomainCommon {
  ...
  Map toJson() {
    ...
    RecipeUtil.addIfNotNull(jsonMap, "category",   category != null ? category.toJson() : null);
  ...
  Recipe.fromJson(Map jsonMap) {
    ...
    if (jsonMap['category'] != null)   this.category   = new Category.fromJson(jsonMap['category']);
